...
class NPC(pygame.sprite.Sprite):
    def __init__(self, game, pos=(10.5, 5.5), scale=1.0, animation_time=180):
        ...
        self.stagger_image = [pygame.Surface(size, pygame.SRCALPHA).convert_alpha()]
        self.visceral_image = [pygame.Surface(size, pygame.SRCALPHA).convert_alpha()]
        ...
        pygame.draw.rect(self.stagger_image[0], (200, 200, 0), self.stagger_image[0].get_rect())
        pygame.draw.rect(self.visceral_image[0], (255, 100, 0), self.visceral_image[0].get_rect())
    ...
    def check_wall(self, x, y):
        ...
        if 0 <= tile_y < self.game.map.height_tiles and 0 <= tile_x < self.game.map.width_tiles:
            return self.game.map.is_walkable(x, y)
        return False
    ...
    def find_path(self, start, goal):
        ...
        while queue:
            ...
            for dx, dy in directions:
                ...
                if self.check_wall(neighbor[0], neighbor[1]):
